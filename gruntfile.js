...
module.exports = function(grunt) {
  ...
  // Default task(s).
  grunt.registerTask('default', ['less', 'lint', 'concurrent:default']);

  // Debug task.
  grunt.registerTask('debug', ['less', 'lint', 'concurrent:debug']);

  // Lint task(s).
  grunt.registerTask('lint', ['jshint', 'csslint']);

  // Build task(s).
  grunt.registerTask('build', ['less', 'lint', 'loadConfig', 'ngAnnotate',
    'uglify',
    'cssmin'
  ]);
